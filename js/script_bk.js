          ...
          if(response.ok) { // Check if response went through
              response.json().then(function(data) { 
				 ...
				 // XMVrawPrice = Number(Math.round(data.price+'e'+2)+'e-'+2);
				  ...
				  var XMVrw = data.blockReward.toFixed(3);
				...
				+ data.price_usd.toFixed(3) + ' | 24h ('+ data.percentChange_24h.toFixed(2) +'%)</p></div></div></div><div class="col-sm-6 pl-md-0"><div class="boxes"><i class="fa fa-gift"></i><div class="r-bx">'
